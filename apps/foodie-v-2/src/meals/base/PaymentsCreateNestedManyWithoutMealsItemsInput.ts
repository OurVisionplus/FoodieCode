...
@InputType()
class PaymentsCreateNestedManyWithoutMealsItemsInput {
...
export { PaymentsCreateNestedManyWithoutMealsItemsInput as PaymentsCreateNestedManyWithoutMealsItemsInput };
