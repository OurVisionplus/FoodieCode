...
@InputType()
class CommentsCreateNestedManyWithoutMealsItemsInput {
...
export { CommentsCreateNestedManyWithoutMealsItemsInput as CommentsCreateNestedManyWithoutMealsItemsInput };
