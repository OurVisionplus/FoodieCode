...
import { MealsFindManyArgs } from "../../meals/base/MealsFindManyArgs";
import { Meals } from "../../meals/base/Meals";
...
export class UserControllerBase {
  ...
  async findMealsItems(
    ...
    const query = plainToClass(MealsFindManyArgs, request.query);
    const results = await this.service.findMealsItems(params.id, {
      ...query,
      select: {
        createdAt: true,
        description: true,
  ...
  @common.Post("/:id/mealsItems")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectMealsItems(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: MealsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      mealsItems: {
        connect: body,
  ...
  @common.Patch("/:id/mealsItems")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async updateMealsItems(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: MealsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/mealsItems")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectMealsItems(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: MealsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
