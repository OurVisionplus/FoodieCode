...
export class PaymentsResolverBase {
  ...
  async getMeal(@graphql.Parent() parent: Payments): Promise<Meals | null> {
  ...
  async getUser(@graphql.Parent() parent: Payments): Promise<User | null> {
